...
[ -d /opt/homebrew/Cellar/ruby/3.3.5/bin ] && export PATH=/opt/homebrew/Cellar/ruby/3.3.5/bin:$PATH
...
alias ffc='fvm flutter pub global activate flutterfire_cli && flutterfire configure --project'
