...
export JAVA_HOME=~/Library/Application\ Support/JetBrains/Toolbox/apps/AndroidStudio/ch-0/222.4459.24.2221.9862592/Android\ Studio.app/Contents/jbr/Contents/Home
...
alias adbu="adb shell pm list packages -3 | cut -d: -f2 | tr '\r' ' ' | grep -v com.adguard.android | grep -v com.cisco.anyconnect.vpn.android.avf | grep -v com.deploygate | grep -v com.piriform.ccleaner | grep -v com.Slack | xargs -n1 -r -t adb uninstall"
