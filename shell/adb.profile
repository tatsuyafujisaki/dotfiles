...
alias adbu="adb shell pm list packages -3 | cut -d: -f2 | tr '\r' ' ' | grep -v com.adguard.android | grep -v com.cisco.anyconnect.vpn.android.avf | grep -v com.deploygate | grep -v com.Slack | xargs -n1 -r -t adb uninstall"
