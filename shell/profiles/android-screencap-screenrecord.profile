...
alias adbs='(cd ~/Desktop && adb exec-out screencap -p > screenshot.png && webp_file=$(my_cwebp screenshot.png) && timestamp=$(date +"%Y-%m-%d_%H-%M-%S") && mv "$webp_file" ${timestamp}.webp && open ${timestamp}.webp)'
